  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the Power of Streamlined Human Resources with HR Information System - Your Ultimate Solution for Employee Data, Vacation, and Payroll Management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the Power of Streamlined Human Resources with HR Information System - Your Ultimate Solution for Employee Data, Vacation, and Payroll Management.`}
            </Text>
            <Box
